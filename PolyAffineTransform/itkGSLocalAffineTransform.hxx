 ...
 *
 *=========================================================================*/
#ifndef __itkGSLocalAffineTransform_hxx
#define __itkGSLocalAffineTransform_hxx
...
GSLocalAffineTransform< TScalarType, NDimensions >::GSLocalAffineTransform():Superclass(ParametersDimension)
{
  this->m_StartTime = 0;
  this->m_StopTime = 0;
...
/** Constructor with default arguments */
template< class TScalarType, unsigned int NDimensions >
GSLocalAffineTransform< TScalarType, NDimensions >::GSLocalAffineTransform(unsigned int parametersDimension):
...
template< class TScalarType, unsigned int NDimensions >
GSLocalAffineTransform< TScalarType, NDimensions >::GSLocalAffineTransform(const MatrixType & matrix,
...
/**  Destructor */
template< class TScalarType, unsigned int NDimensions >
GSLocalAffineTransform< TScalarType, NDimensions >::
...
GSLocalAffineTransform< TScalarType, NDimensions >::ComputeLogarithmMatrix(
...
template< class TScalarType, unsigned int NDimensions >
typename GSLocalAffineTransform< TScalarType, NDimensions >::AffineTransformPointer
GSLocalAffineTransform< TScalarType, NDimensions >::ComputeExponentialTransform(
...
template< class TScalarType, unsigned int NDimensions >
void
GSLocalAffineTransform< TScalarType, NDimensions >::SetHomogeneousTransform(
  AffineTransformPointer &affineTransform,
...
template< class TScalarType, unsigned int NDimensions >
void
GSLocalAffineTransform< TScalarType, NDimensions >::GetHomogeneousMatrix(
...
template< class TScalarType, unsigned int NDimensions >
typename GSLocalAffineTransform< TScalarType, NDimensions >::OutputVectorType
GSLocalAffineTransform< TScalarType, NDimensions >
::GetVelocityAtPoint(const PointType &point)
{
  OutputVectorType velocity;
  // ignore determine if this->GetVelocityMatrix() has been computed, need to call once beforehand.

  for (unsigned int r=0; r<NDimensions; r++)
    {
    velocity[r] = this->m_VelocityMatrix[r][NDimensions];
    for (unsigned int c=0; c<NDimensions; c++)
      {
      velocity[r] += this->m_VelocityMatrix[r][c] * point[c];
      }
    }
  return velocity;
}
...
template< class TScalarType, unsigned int NDimensions >
void
GSLocalAffineTransform< TScalarType, NDimensions >::AddFixedPoint(InputPointType point)
{
...
template< class TScalarType, unsigned int NDimensions >
void
GSLocalAffineTransform< TScalarType, NDimensions >::PrintSelf(std::ostream & os, Indent indent) const
{
  Superclass::PrintSelf(os, indent);
  os << "Velocity Matrix:" << indent << m_VelocityMatrix;
}
